...
- [`check_inherits()`](http://docs.jimbrig.com/shinyhealth/reference/check_inherits.md)
  [`check_inherits2()`](http://docs.jimbrig.com/shinyhealth/reference/check_inherits.md)
  [`check_inherits_any()`](http://docs.jimbrig.com/shinyhealth/reference/check_inherits.md)
  [`check_inherits_all()`](http://docs.jimbrig.com/shinyhealth/reference/check_inherits.md)
